...
<head>
    ...
    <title>สุ่มไพ่ทาโรต์เมเจอร์</title>
<style>
    body {
        margin: 0;
        padding: 20px;
        font-family: 'Segoe UI', sans-serif;
        background: radial-gradient(ellipse at center, #1c1c2b 0%, #0c0c12 100%);
        color: #f0eaff;
        min-height: 100vh;
    }
    ...
    .card, label {
        background: linear-gradient(145deg, rgba(64, 38, 103, 0.8), rgba(27, 18, 43, 0.9));
...
<div class="control-panel">
    ...
    <script>
        const tarotCards = [
            ...
            { name: "The Tower", file: "C17.jpg", meanings: { ความหมาย : "จะเกิดการเปลี่ยนแปลงครั้งใหญ่ ส่วนมากจะเป็นไปในทางที่ไม่ค่อยจะดีนัก อาจมีเหตุการณ์ทำให้คุณเสียความรู้สึก หรือสิ้นศรัทธาในบางคนได้"} },
